...
<template>
  <div class="min-h-screen bg-gray-50/50 text-gray-900 font-sans selection:bg-emerald-100 selection:text-emerald-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 py-8">
        ...
        <main class="lg:col-span-6 min-h-[80vh]">
          <!-- Mobile Header -->
          <div class="lg:hidden mb-6 flex items-center justify-between bg-white p-4 rounded-3xl shadow-sm">
             ...
             <div class="w-10 h-10 rounded-full bg-gray-100 overflow-hidden border-2 border-white shadow-sm">
                <img
                  :src="currentUser?.avatar_url || 'https://api.dicebear.com/9.x/micah/svg?seed=Guest'"
                  alt="Avatar"
