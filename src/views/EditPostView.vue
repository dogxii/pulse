...
<template>
  <div class="min-h-screen bg-gray-50/50">
    <div class="max-w-2xl mx-auto px-4 py-8">
      ...
      <!-- Load Error State -->
      <div v-else-if="loadError" class="py-20 text-center bg-white rounded-3xl">
      ...
      <div v-else-if="post" class="space-y-6">
        ...
        <div class="bg-white rounded-3xl p-6 md:p-8 shadow-sm">
          ...
          <div class="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p class="text-xs text-gray-400">Editing post</p>
            </div>
          </div>
          ...
          <div class="flex items-center justify-between pt-4 border-t border-gray-100">
            ...
            <div class="flex items-center gap-3">
              <button
                class="px-5 py-2.5 text-gray-600 rounded-xl font-medium text-sm hover:bg-gray-100 transition-colors cursor-pointer disabled:opacity-50"
                :disabled="isSubmitting"
                @click="handleCancel"
              >
                Cancel
        ...
        <div class="p-4 bg-white rounded-2xl shadow-sm">
          ...
          <div class="grid grid-cols-2 gap-2 text-xs text-gray-500">
            <div>
              <code class="bg-gray-100 px-1 rounded">**bold**</code> → <strong>bold</strong>
            </div>
